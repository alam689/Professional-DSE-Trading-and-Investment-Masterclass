...
export const CHAPTERS = [
  ...
  { n: 26, part: 'III', status: 'complete', title: { en: 'Charting Foundations', bn: 'চার্টিংয়ের ভিত্তি' } },
  { n: 27, part: 'III', status: 'complete', title: { en: 'Candlestick Anatomy', bn: 'ক্যান্ডেলস্টিকের গঠন' } },
  { n: 28, part: 'III', status: 'complete', title: { en: 'Candlestick Reversal Patterns', bn: 'ক্যান্ডেলস্টিক রিভার্সাল প্যাটার্ন' } },
  { n: 29, part: 'III', status: 'complete', title: { en: 'Candlestick Continuation Patterns', bn: 'ক্যান্ডেলস্টিক কন্টিনিউয়েশন প্যাটার্ন' } },
  { n: 30, part: 'III', status: 'complete', title: { en: 'Support & Resistance', bn: 'সাপোর্ট ও রেজিস্ট্যান্স' } },
  { n: 31, part: 'III', status: 'complete', title: { en: 'Trendlines & Channels', bn: 'ট্রেন্ডলাইন ও চ্যানেল' } },
  { n: 32, part: 'III', status: 'complete', title: { en: 'Chart Patterns — Reversal', bn: 'চার্ট প্যাটার্ন — রিভার্সাল' } },
  { n: 33, part: 'III', status: 'complete', title: { en: 'Chart Patterns — Continuation', bn: 'চার্ট প্যাটার্ন — কন্টিনিউয়েশন' } },
  { n: 34, part: 'III', status: 'complete', title: { en: 'Moving Averages', bn: 'মুভিং অ্যাভারেজ' } },
  { n: 35, part: 'III', status: 'complete', title: { en: 'MACD', bn: 'MACD' } },
  { n: 36, part: 'III', status: 'complete', title: { en: 'RSI', bn: 'RSI' } },
  { n: 37, part: 'III', status: 'complete', title: { en: 'Stochastic Oscillator', bn: 'স্টোক্যাস্টিক অসিলেটর' } },
  { n: 38, part: 'III', status: 'complete', title: { en: 'Bollinger Bands', bn: 'বলিঞ্জার ব্যান্ড' } },
  { n: 39, part: 'III', status: 'complete', title: { en: 'ATR & Volatility', bn: 'ATR ও অস্থিরতা' } },
  { n: 40, part: 'III', status: 'complete', title: { en: 'Volume Analysis', bn: 'ভলিউম বিশ্লেষণ' } },
  { n: 41, part: 'III', status: 'complete', title: { en: 'Fibonacci Retracement & Extension', bn: 'ফিবোনাচ্চি রিট্রেসমেন্ট ও এক্সটেনশন' } },
  { n: 42, part: 'III', status: 'complete', title: { en: 'Dow Theory', bn: 'ডাও তত্ত্ব' } },
  { n: 43, part: 'III', status: 'complete', title: { en: 'Elliott Wave', bn: 'এলিয়ট ওয়েভ' } },
  { n: 44, part: 'III', status: 'complete', title: { en: 'Divergence Analysis', bn: 'ডাইভারজেন্স বিশ্লেষণ' } },
  { n: 45, part: 'III', status: 'complete', title: { en: 'Multi-Indicator Confluence', bn: 'বহু-নির্দেশক সমন্বয়' } },
